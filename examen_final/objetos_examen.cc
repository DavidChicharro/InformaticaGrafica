...
_triangulo::_triangulo(float base, float al){
	float p=0.1;
	r=0.9; g=0.6; b=0.2;

	//vertices
	vertices.resize(6);
	vertices[0].x=-base/2.0; vertices[0].y=0; vertices[0].z=0;
	vertices[1].x=base/2.0; vertices[1].y=0; vertices[1].z=0;
	vertices[2].x=0; vertices[2].y=al; vertices[2].z=0;
	vertices[3].x=-base/2.0; vertices[3].y=0; vertices[3].z=-p;
	vertices[4].x=base/2.0; vertices[4].y=0; vertices[4].z=-p;
	vertices[5].x=0; vertices[5].y=al; vertices[5].z=-p;
	...
	caras[5]._0=4;caras[5]._1=3;caras[5]._2=5;
}
